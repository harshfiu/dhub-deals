    ...
    <div>
      ...
      <div className="flex items-start justify-between mb-6 gap-4 flex-wrap">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Manage your restaurant deals</p>
        </div>
      ...
      {filtered.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-gray-500 font-medium">No {activeTab !== "All" ? activeTab.toLowerCase() : ""} deals found</p>
          <p className="text-gray-400 text-sm mt-1">Create a new deal to get started</p>
        </div>
      ) : (
